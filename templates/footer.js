...
const hideUntil = require('../styles/media-query').hideUntil
        ...
        <div class="${grid.row}">
          <div class="${footer.column}">
            ...
            <ul class="${footer.list}">
              <li class="${hideUntil(deviceWidths['md'])}"><a class="${footer.link}" href="${domain}/">Home</a></li>
              <li class="${hideUntil(deviceWidths['md'])}"><a class="${footer.link}" href="${domain}/blog/">Blog</a></li>
              <li><a class="${footer.link}" href="${domain}/about/">About Us</a></li>
              <li><a class="${footer.link}" href="${domain}/portfolio/">Our Work</a></li>
              <li><a class="${footer.link}" href="${domain}/unleash/">Unleash</a></li>
              <li><a class="${footer.link}" href="${domain}/our-developers/">Our Developers</a></li>
              <li><a class="${footer.link}" href="${domain}/hire-developers/">Hire Developers</a></li>
              <li><a class="${footer.link}" href="${domain}/join/">Join as a Developer</a></li>
            </ul>
          </div>
          <div class="${footer.column}">
            <h4 class="${footer.title}">Resources</h4>
            <ul class="${footer.list}">
              <li><a class="${footer.link}" href="${domain}/case-studies/">Case Studies</a></li>
              <li><a class="${footer.link}" href="${domain}/authors/">Write for us</a></li>
            </ul>
          </div>
          <div class="${footer.column}">
            <h4 class="${footer.title}">Hire Developers</h4>
            <ul class="${footer.list}">
              <li><a class="${footer.link}" href="${domain}/hire-react-developers/">React Developers</a></li>
              <li><a class="${footer.link}" href="${domain}/hire-angular-developers/">Angular Developers</a></li>
              <li><a class="${footer.link}" href="${domain}/hire-javascript-developers/">Javascript Developers</a></li>
              <li><a class="${footer.link}" href="${domain}/hire-node-developers/">Node Developers</a></li>
              <li><a class="${footer.link}" href="${domain}/hire-php-developers/">PHP Developers</a></li>
              <li><a class="${footer.link}" href="${domain}/hire-laravel-developers/">Laravel Developers</a></li>
              <li><a class="${footer.link}" href="${domain}/hire-symfony-developers/">Symfony Developers</a></li>
            </ul>
          </div>
          <div class="${footer.column}">
            <h4 class="${footer.title}">Connect</h4>
            <ul class="${footer.list}">
              <li><a class="${footer.link}" href="${domain}/blog/">Blog</a></li>
